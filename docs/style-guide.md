...
| Face | `faceHtml()` → `.face` | 4:5 photo or initials. `.out` greyed, `.live` accent ring, `.won` gold ring. Sizes: 20–26px in rows and chips (`--r-sm`), 28–36px in tables and cards, 72–104px as a portrait (`--r-xl`). |
