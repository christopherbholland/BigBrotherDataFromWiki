...
`#player=26/Angela`, `#comps=28`, `#comps=major`, `#comp=The%20Wall`, `#endgame=26`, `#finale=26`, `#afh`, `#hoh=all` or `#veto=26`, so it can be shared or embedded directly. The detail data lives in
